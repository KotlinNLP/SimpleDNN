...
/**
 * A helper which evaluates a dataset of [SequenceExampleWithFinalOutput]s.
 *
 ...
 */
class SequenceWithFinalOutputEvaluator<NDArrayType: NDArray<NDArrayType>>(
  ...
  private val afterEachEvaluation: (example: SequenceExampleWithFinalOutput<NDArrayType>,
                                    isCorrect: Boolean,
   ...
   */
  override fun evaluate(example: SequenceExampleWithFinalOutput<NDArrayType>) {
