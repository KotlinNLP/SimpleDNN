 ...
 *
 */
class SequenceValidationHelper(override val neuralProcessor: RecurrentNeuralProcessor,
                               outputEvaluationFunction: OutputEvaluationFunction): ValidationHelper<SequenceExample>(
