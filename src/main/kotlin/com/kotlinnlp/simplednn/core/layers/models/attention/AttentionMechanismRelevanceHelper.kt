...
/**
 * The helper which calculates the relevance of the input of an [AttentionMechanismLayer] respect of its output.
 *
 * @property layer the layer in which to calculate the input relevance
 */
class AttentionMechanismRelevanceHelper(
  ...
  override fun getInputRelevance(layerContributions: LayerParameters<*>): NDArray<*> {
    throw NotImplementedError("Relevance not available for the Attention layer.")
  }
}
