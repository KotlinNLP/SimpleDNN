 ...
 * @property id an identification number useful to track a specific [DotLayer]
 */
class DotLayer(
  internal val inputArray1: AugmentedArray<DenseNDArray>,
  internal val inputArray2: AugmentedArray<DenseNDArray>,
  override val params: DotLayerParameters,
  id: Int = 0
) :
  ItemsPool.IDItem,
   ...
   */
  override val forwardHelper = DotForwardHelper(layer = this)

  /**
   * The helper which execute the backward.
   */
  override val backwardHelper = DotBackwardHelper(layer = this)
