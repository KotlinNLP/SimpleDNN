...
/**
 * The parameters of the Avg layer.
 *
 * @property inputSize the size of each input
 * @property nInputs the number of input arrays
 */
class AvgLayerParameters(
  inputSize: Int,
  val nInputs: Int
) : MergeLayerParameters<AvgLayerParameters>(
   ...
   */
  override fun copy() = AvgLayerParameters(inputSize = this.inputSize, nInputs = this.nInputs)
}
