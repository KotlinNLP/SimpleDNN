...
/**
 * The helper which calculates the relevance of the input of an [NewRecirculationLayer] respect of its output.
 *
 * @property layer the layer in which to calculate the input relevance
 */
class NewRecirculationRelevanceHelper(
  override val layer: NewRecirculationLayer
) : RelevanceHelper<DenseNDArray>(layer) {

  /**
   * Not available for the Attention layer.
   *
  ...
  override fun getInputRelevance(layerContributions: LayerParameters<*>): NDArray<*> {
    throw NotImplementedError("Relevance not available for the NewRecirculation layer.")
  }
}
