...
/**
 * The parameters of the Dot layer.
 *
 * @property inputSize the size of each input
 */
class DotLayerParameters(
  inputSize: Int
) : MergeLayerParameters<DotLayerParameters>(
  ...
  /**
   * @return a new [DotLayerParameters] containing a copy of all parameters of this
   */
  override fun copy() = DotLayerParameters(inputSize = this.inputSize)
}