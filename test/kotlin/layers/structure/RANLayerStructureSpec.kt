  ...
  describe("a RANLayerStructure") {
    ...
    context("forward") {
      ...
      on("without previous state context") {
        ...
        it("should match the expected outputArray") {
          assertEquals(true, layer.outputArray.values.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.384, -0.025, 0.05, 0.892, -0.564)),
            tolerance = 0.0005))
        }
      }
      ...
      on("with previous state context") {
        ...
        it("should match the expected outputArray") {
          assertEquals(true, layer.outputArray.values.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.504, 0.011, 0.04, 0.785, -0.788)),
            tolerance = 0.0005))
        }
      }
    }
    ...
    context("backward") {
      ...
      on("without previous and next state") {
        ...
        it("should match the expected errors of the outputArray") {
          assertEquals(true, layer.outputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.186, -0.775, 0.2, -0.748, -1.014)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the input gate") {
          assertEquals(true, layer.inputGate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.045, 0.015, 0.005, -0.316, 0.354)),
            tolerance = 0.0005))
        }
        ...
        it("should match the expected errors of the candidate") {
          assertEquals(true, layer.candidate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.074, -0.195, 0.1, -0.527, -0.459)),
            tolerance = 0.0005))
        }
        ...
        it("should match the expected errors of the inputArray") {
          assertEquals(true, layer.inputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.418, 0.340, -0.212, 0.392)),
            tolerance = 0.0005))
        }
      }
      ...
      on("with previous state only") {
        ...
        it("should match the expected errors of the outputArray") {
          assertEquals(true, layer.outputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.066, -0.739, 0.19, -0.855, -1.238)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the input gate") {
          assertEquals(true, layer.inputGate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.013, 0.014, 0.005, -0.256, 0.434)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the forget gate") {
          assertEquals(true, layer.forgetGate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.001, -0.022, -0.003, 0.134, 0.195)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the candidate") {
          assertEquals(true, layer.candidate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.047, -0.185, 0.105, -0.702, -0.662)),
            tolerance = 0.0005))
        }
        ...
        it("should match the expected errors of the inputArray") {
          assertEquals(true, layer.inputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.279, 0.578, -0.430, 0.264)),
            tolerance = 0.0005))
        }
      }
      ...
      on("with next state only") {
        ...
        it("should match the expected errors of the outputArray") {
          assertEquals(true, layer.outputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.336, -0.425, 0.600, -1.598, -1.204)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the input gate") {
          assertEquals(true, layer.inputGate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.082, 0.008, 0.015, -0.675, 0.420)),
            tolerance = 0.0005))
        }
        ...
        it("should match the expected errors of the candidate") {
          assertEquals(true, layer.candidate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.133, -0.107, 0.300, -1.126, -0.545)),
            tolerance = 0.0005))
        }
        ...
        it("should match the expected errors of the inputArray") {
          assertEquals(true, layer.inputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.755, 0.924, -0.715, 0.204)),
            tolerance = 0.0005))
        }
      }
      ...
      on("with previous and next state") {
        ...
        it("should match the expected errors of the outputArray") {
          assertEquals(true, layer.outputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.216, -0.389, 0.590, -1.705, -1.428)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the input gate") {
          assertEquals(true, layer.inputGate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.044, 0.007, 0.015, -0.51, 0.501)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the forget gate") {
          assertEquals(true, layer.forgetGate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.003, -0.011, -0.008, 0.268, 0.225)),
            tolerance = 0.0005))
        }

        it("should match the expected errors of the candidate") {
          assertEquals(true, layer.candidate.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(-0.156, -0.097, 0.325, -1.399, -0.764)),
            tolerance = 0.0005))
        }
        ...
        it("should match the expected errors of the inputArray") {
          assertEquals(true, layer.inputArray.errors.equals(
            DenseNDArrayFactory.arrayOf(doubleArrayOf(0.712, 1.228, -1.069, -0.06)),
            tolerance = 0.0005))
        }
      }
    }
